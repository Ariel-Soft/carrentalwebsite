...
jQuery(document).ready(function(){
	...
	jQuery('#pp_import_content_button').on( 'click', function(){
		if(jQuery('#grandcarrental_import_demo_content').val()=='')
		{
        ...
        var data = {
            ...
            'demo': jQuery('#grandcarrental_import_demo_content').val()
        };

        jQuery.post(ajaxurl, data, function(response) {
            jQuery('.import_message').html('<div class="import_message_success">All done. Note: You might want to also <a href="http://themes.themegoods.com/grandcarrental/doc/import-demo-revolution-sliders/" target="_blank">import demo Revolution Sliders.</a></div>');
