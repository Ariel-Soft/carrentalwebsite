...
if(!empty($tg_car_recently_view))
 {
	$recently_view_cars = grandcar_get_recently_view_cars();
...
<?php
 if( is_page('3153') || is_page('3549') || is_page('3553') || is_page('3556') || is_page('2'))
// if( (is_page('3153')) || (is_page('3187')))
{
...
<script type="text/javascript" src="https://cdn.rawgit.com/Eonasdan/bootstrap-datetimepicker/e8bddc60e73c1ec2475f827be36e1957af72e2ea/build/js/bootstrap-datetimepicker.min.js"></script>
            ...
            jQuery(document).ready(function () {
				...
				decrementMinutes: function () {
					...
					jQuery(window).on('load', function(){
						//alert(jQuery('#timepicker').data("DateTimePicker").date());
					//var checknew = jQuery('#timepicker').data("DateTimePicker").date().add(30, 'minutes');
				...
				jQuery('#timepicker input').click(function(event){
				   jQuery('#timepicker ').data("DateTimePicker").show();
				   
				   
				   
				});
				jQuery('#datetimepicker1 input').click(function(event){
				   jQuery('#datetimepicker1 ').data("DateTimePicker").show();
				   
				   
				   
				});
   
				jQuery('#datetimepicker2 input').click(function(event){
				   jQuery('#datetimepicker2 ').data("DateTimePicker").show();
				   
				});
				jQuery('#timepicker2 input').click(function(event){
				   jQuery('#timepicker2').data("DateTimePicker").show();
						...
						jQuery('#datetimepicker2').data("DateTimePicker").date(e.date.add(30, 'minutes'));
						jQuery('#datetimepicker1').data("DateTimePicker").hide();
						  jQuery('#datetimepicker2').data("DateTimePicker").show();
					});

				/* 	jQuery("#datetimepicker2").on("dp.change", function(e) {										
						  jQuery('#datetimepicker2').data("DateTimePicker").hide();
					}); */
				
					
		/* 			jQuery("#pickidloc span ,#drpLocation").click(function () {
											
						var size = jQuery('#drpLocation option').size();
						if (size != jQuery("#drpLocation").prop('size')) {
							jQuery("#drpLocation").prop('size', size);
						} else {
							jQuery("#drpLocation").prop('size', 1);
						}
					});

					jQuery("#drpidloc span , #drpLocation2").click(function () {
											
						var size = jQuery('#drpLocation2 option').size();
						if (size != jQuery("#drpLocation2").prop('size')) {
							jQuery("#drpLocation2").prop('size', size);
						} else {
							jQuery("#drpLocation2").prop('size', 1);
						}
					}); */
							...
							jQuery( "#hidservh" ).click(function() {
			 jQuery( "#hideMe" ).slideToggle( "slow", function() {
				// Animation complete.
			  });
			});
		...
		<style>
		.timeWithText:before{
    content: "\e023  Select Pick-Up Time";
}
</style>
<?php } ?>
